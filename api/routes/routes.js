...
router
    ...
    .route("/lists/:user")
        ...
        .put(checkAuth, (req, res) => {
            ...
            pool.query(`UPDATE lists SET name = $1, icon = $2, color = $3 WHERE id = $4`, [list.name, list.icon, list.color, list.id])
                .then(() => {
    ...
    .route("/lists/:id")
        ...
        .put(checkAuth, (req, res) => {
            ...
            pool.query(`UPDATE items SET name = $1 WHERE id = $2`, [item.name, item.id])
                .then(() => {
        ...
        .delete(checkAuth, (req, res) => {
            ...
            pool.query(`DELETE FROM items WHERE id = $1`, [item.id])
                .then(() => {
